...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { num_capacity: @tour.num_capacity, price: @tour.price, tour_name: @tour.tour_name }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { num_capacity: @tour.num_capacity, price: @tour.price, tour_name: @tour.tour_name }
    assert_redirected_to tour_path(assigns(:tour))
  end
