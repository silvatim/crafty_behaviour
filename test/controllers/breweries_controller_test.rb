...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { address: @brewery.address, brewery_name: @brewery.brewery_name, description: @brewery.description, image: @brewery.image, lat: @brewery.lat, long: @brewery.long, website: @brewery.website }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { address: @brewery.address, brewery_name: @brewery.brewery_name, description: @brewery.description, image: @brewery.image, lat: @brewery.lat, long: @brewery.long, website: @brewery.website }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
